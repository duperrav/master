...
class AuthorResourceIT {
    ...
    public static Author createEntity(EntityManager em) {
        Author author = new Author().name(DEFAULT_NAME).birthdate(DEFAULT_BIRTHDATE);
        return author;
    }
    ...
    public static Author createUpdatedEntity(EntityManager em) {
        Author author = new Author().name(UPDATED_NAME).birthdate(UPDATED_BIRTHDATE);
        return author;
    }
    ...
    void putNewAuthor() throws Exception {
        ...
        updatedAuthor.name(UPDATED_NAME).birthdate(UPDATED_BIRTHDATE);
    ...
    void partialUpdateAuthorWithPatch() throws Exception {
        ...
        partialUpdatedAuthor.birthdate(UPDATED_BIRTHDATE);
    ...
    void fullUpdateAuthorWithPatch() throws Exception {
        ...
        partialUpdatedAuthor.name(UPDATED_NAME).birthdate(UPDATED_BIRTHDATE);
