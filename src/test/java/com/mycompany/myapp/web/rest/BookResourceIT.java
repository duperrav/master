...
class BookResourceIT {
    ...
    private static final LocalDate DEFAULT_PUBLICATIONDATE = LocalDate.ofEpochDay(0L);
    private static final LocalDate UPDATED_PUBLICATIONDATE = LocalDate.now(ZoneId.systemDefault());
    ...
    public static Book createEntity(EntityManager em) {
        Book book = new Book()
            ...
            .publicationdate(DEFAULT_PUBLICATIONDATE)
            .price(DEFAULT_PRICE);
        return book;
    }
    ...
    public static Book createUpdatedEntity(EntityManager em) {
        Book book = new Book()
            ...
            .publicationdate(UPDATED_PUBLICATIONDATE)
            .price(UPDATED_PRICE);
        return book;
    }
    ...
    void createBook() throws Exception {
        ...
        assertThat(testBook.getPublicationdate()).isEqualTo(DEFAULT_PUBLICATIONDATE);
    ...
    void getAllBooks() throws Exception {
        ...
        restBookMockMvc
            ...
            .andExpect(jsonPath("$.[*].publicationdate").value(hasItem(DEFAULT_PUBLICATIONDATE.toString())))
    ...
    void getBook() throws Exception {
        ...
        restBookMockMvc
            ...
            .andExpect(jsonPath("$.publicationdate").value(DEFAULT_PUBLICATIONDATE.toString()))
    ...
    void putNewBook() throws Exception {
        ...
        updatedBook.title(UPDATED_TITLE).description(UPDATED_DESCRIPTION).publicationdate(UPDATED_PUBLICATIONDATE).price(UPDATED_PRICE);
        ...
        assertThat(testBook.getPublicationdate()).isEqualTo(UPDATED_PUBLICATIONDATE);
